...
namespace SalesSupport.Template.Web.Models;

/// <summary>結果の受け取り方です。画面表示と直接ダウンロードの両方をテンプレートで示します。</summary>
...
/// <remarks>テンプレートでは固定値です。コードマスタで管理する値へ変更する場合は`ICodeMasterReader`から取得します。</remarks>
